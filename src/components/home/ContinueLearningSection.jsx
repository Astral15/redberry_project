  ...
  return (
    <article className="rounded-[1vw] bg-white px-[2.4%] py-[2%] shadow-[0_0.1vw_0.25vw_rgba(0,0,0,0.05)]">
      <div className="ml-[2.2%] mt-[2.5%] mb-[2.5%] mr-[2.2%] flex items-start gap-[2.6%]">
        <img
          src={course.image || "/your_course.png"}
          alt="Course"
          ...
          <div className="min-w-0 flex-1">
            <div className="flex mb-[1.5%] items-center justify-between gap-[1%]">
              <p className="text-[0.82vw] text-[#8b8b8b]">
                Lecturer {course.instructor || "Marilyn Mango"}
              </p>
      ...
      <div className="flex items-end ml-[2.2%] mb-[2.5%] mr-[2.2%]">
        ...
        <button
          ...
          className="ml-[7.2%] flex h-[2.28vw] min-h-[2.9rem] w-[4.7vw] min-w-[5rem] items-center justify-center rounded-[0.8vw] border border-[#8e83ff] bg-white text-[1.25vw] font-medium text-[#4f46e5] hover:bg-[#f6f5ff]"
        >
          Continue
        </button>
      </div>
...
export default function ContinueLearningSection({ courses = [], onSeeAll }) {
    ...
    <section className="mx-auto mt-[3.2%] w-[81.56%]">
      <div className="flex items-end justify-between">
        ...
        <button
          type="button"
          onClick={onSeeAll}
          className="text-[1.1vw] font-medium text-[#4f46e5] underline"
        >
          See All
        </button>
      </div>
      ...
      <div className="mt-[1.8%] grid grid-cols-3 gap-[2.04%]">
        {visibleCourses.map((course) => (
          <ContinueCard key={course.courseId} course={course} />
        ))}
      </div>
    </section>
  );
