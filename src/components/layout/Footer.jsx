        ...
        <div className="grid grid-cols-[1.4fr_0.5fr_0.5fr_0.7fr] gap-[6%]">
          ...
          <div>
            ...
            <div className="mt-[11%] space-y-[12%] text-[1.05vw] text-[#6a6a6a]">
              <Link to="/dashboard" className="block hover:text-[#4f46e5]">
                Dashboard
              </Link>
              <Link
                to={isAuthenticated ? "/browse-courses" : "/browse-courses-guest"}
                className="block hover:text-[#4f46e5]"
              >
                Browse Courses
              </Link>
            </div>
            ...
            <div className="mt-[11%] space-y-[12%] text-[1.05vw] text-[#6a6a6a]">
              ...
              {isAuthenticated && (
                <button
                  ...
                  className="block text-left text-[1.05vw] text-[#6a6a6a] hover:text-[#4f46e5]"
                >
                  Log Out
                </button>
              )}
